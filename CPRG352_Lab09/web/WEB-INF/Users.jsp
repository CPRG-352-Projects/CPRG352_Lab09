                        ...
                        <c:forEach items="${users}" var="user">
                            <div class="col-sm-3">
                                <div class="card text-white bg-dark border-light mb-3">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">${user.getRole().getRoleName()}</h5>
                                        <p class="card-text">${user.getFirstName()} ${user.getLastName()}</p>
                                        <p class="card-text">${user.getEmail()}</p>
                                        <%-- This is a form for the edit button--%>
                                        <form action="Users" method="post">
                                            <input type="hidden" name="action" value="edit">
                                            <input type="hidden" name="toEdit" value="${user.getEmail()}">
                                            <button type="submit" class="btn btn-warning">Edit</button>
                                        </form>
                                        <%-- This is a form for the delete button--%>    
                                        <form action="Users" method="post">
                                            <input type="hidden" name="action" value="delete"> 
                                            <input type="hidden" name="toDelete" value="${user.getEmail()}">
                    ...
                    <form class="border border-info p-2" action="Users" method="post">
                        ...
                        <div class="input-group mb-3">
                            <select class="form-select" id="inputGroupSelect01" name="updatedRole">
                                ...
                                <c:forEach items="${roleLabel}" var="r">
                                    <c:choose>
                                        <c:when test="${updatedRole == r.getRoleId()}">
